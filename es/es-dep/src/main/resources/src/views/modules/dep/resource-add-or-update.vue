<template>
  <el-dialog
    ...
    <el-form-item label="资源名称" prop="resourceName">
      <el-input v-model="dataForm.resourceName" placeholder="资源名称"></el-input>
    </el-form-item>
    <el-form-item label="资源地址" prop="resourceAddr">
      <el-input v-model="dataForm.resourceAddr" placeholder="资源地址"></el-input>
    </el-form-item>
    <el-form-item label="资源联系方式" prop="resourcePhone">
      <el-input v-model="dataForm.resourcePhone" placeholder="资源联系方式"></el-input>
    </el-form-item>
    <el-form-item label="资源备注" prop="remark">
      <el-input v-model="dataForm.remark" placeholder="资源备注"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          resourcePhone: [
            { required: true, message: '资源联系方式不能为空', trigger: 'blur' }
          ],
          remark: [
            { required: true, message: '资源备注不能为空', trigger: 'blur' }
          ]
        }
      }
    },
